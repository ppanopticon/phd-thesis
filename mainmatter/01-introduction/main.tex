...
\begin{table}[h!]
    ...
    \begin{tabular}{|c|p{10cm}|c|c|} 
     ...
     \hline\hline
     1 & Which commonly used, secondary index structures for NNS (e.g., VA~\cite{Weber:1998Va}, LSH~\cite{Indyk:1998Approximate}, PQ~\cite{jegou:2011pq} based indexes) can cope with changes to data and to what extent? & AS 1 &\\ 
