...
\begin{table}[h!]
    ...
    \begin{tabular}{|c|p{10cm}|c|} 
     ...
     4 & Can we device a model that (temporarily) compensates deterioration of retrieval quality of index structures? & AS 1 \\
...
\todo[inline]{Chapter on DRES as some kind of ``detour''?}