...
It is important to note, that \texttt{Tx} objects simply facilitate the interaction with a \acrshort{dbo} within a mandatory transactional context managed by the transaction manager (see \Cref{section:cottontail_transaction_manager}). The ability to commit or rollback changes is only supported at the level of this overarching context.
