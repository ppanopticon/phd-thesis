...
\begin{table}
    \begin{tabular}{ | l | c | c | c |}
        ...
        \hline
        \acrshort{vaf} \cite{Weber:1998Va} & exact & list & quantisation \\ 
        \hline
        VA+ \cite{Ferhatosmanoglu:2000Vector} & exact & list & quantisation \\ 
        \hline
        \acrshort{lsh} \cite{Indyk1998:Approximate, Wang:2017ASurvey} & approximate, probabilistic & hash table i.a.  & hashing \\ 
        \hline
        \acrshort{pq} \cite{Jegou:2010Product} & approximate & list / inverted file & partitioning / quantisation \\ 
        \hline
