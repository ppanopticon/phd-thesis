...
It has been describe in \Cref{chapter:theory_multimedia_analysis_and_retrieval}, that there are two important assumptions for similiarity based operations, such as similarity search in multimedia retrieval. These assumptions can be summarized as follows:
...
Considerding the definition provided in \Cref{chapter:theory_multimedia_analysis_and_retrieval}, we identify the following (implicit) constraints of the postulated model:
