...
\newglossaryentry{symchangeop}{sort={DFsymchangeop},name=\ensuremath{\mathtt{OP}_c},symbol=\ensuremath{\mathtt{OP}_c},type={symbols},description={A change operation \( \mathtt{OP}_c(\relation, \cdot)\) that can either be an insert, update or delete.}}
\newcommand{\symchangeop}{\glssymbol{symchangeop}}

\newglossaryentry{symchange}{sort={DGsymchange},name=\ensuremath{\mathcal{C}},symbol=\ensuremath{\mathcal{C}},type={symbols},description={A change on relation \( \relation \) with \( \symchange = (\symchangeop, \relation, t, t^{\prime})\).}}
