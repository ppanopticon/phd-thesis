...
\newglossaryentry{symsch}{sort={Bsymsch},name=\ensuremath{\mathtt{SCH}},symbol=\ensuremath{\mathtt{SCH}},type={symbols},description={The schema of a relation \(\symrel \), i.e., all attributes \(\symschema(\symrel) = (\symattr_1, \symattr_2, \ldots, \symattr_N)\) that make up \(\symrel \).}}
\newcommand{\symsch}{\glssymbol{symsch}}

\newglossaryentry{symext}{sort={Bsymext},name=\ensuremath{\mathtt{EXT}},symbol=\ensuremath{\mathtt{EXT}},type={symbols},description={The extent of a relation \(\symrel \), i.e., the tuples \(t_i\) it contains.}}
\newcommand{\symext}{\glssymbol{symext}}
