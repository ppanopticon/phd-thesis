...
\newglossaryentry{rename}{sort={BLrename},name=\ensuremath{\rho},symbol=\ensuremath{\rho},type={symbols},description={The unary rename operator used to rename the attributes \( \attribute \) of a relation \( \relation \). Usually used with subscript to list the desired attributes, e.g. \( \projection_{\attribute_1,\attribute_2} \).}}
\newcommand{\rename}{\glssymbol{rename}}

\newglossaryentry{order}{sort={BMorder},name=\ensuremath{\omega},symbol=\ensuremath{\omega},type={symbols},description={The binary sort operator used to construct a ranked relation \( \rankedrel \).}}
\newcommand{\order}{\glssymbol{order}}

\newglossaryentry{limit}{sort={BNlimit},name=\ensuremath{\lambda},symbol=\ensuremath{\lambda},type={symbols},description={The unary k-selection operator restricts \( \relation \) to the first \( k \) tuples.}}
...
\newglossaryentry{group}{sort={BPgroup},name=\ensuremath{\gamma},symbol=\ensuremath{\gamma},type={symbols},description={The unary group operator aggregates tuples in \( \relation \) to the first \( k \) tuples. Usually printed with a subscript to list the group attributes, e.g. \( \selection_{G} \).}}
...
\newglossaryentry{symdfc}{sort={Csymdfc},name=\ensuremath{\hat{\mathfrak{d}}},symbol=\ensuremath{\hat{\mathfrak{d}}},type={symbols},description={A \gls{dfc} \( \symdfc \colon \domain_q \times \domain_q \times \domain_{1} \cdot \times \domain_{n} \to \symnatural \)}}
